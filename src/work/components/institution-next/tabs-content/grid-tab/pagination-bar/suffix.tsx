...
import SuggestionsSearchInput from "./suggestions-search-input";
...
const Suffix: React.FunctionComponent = () => {
  const classes = useStyles();
  const { setColumnsEditorOpen, importType } = InstitutionGridTabContainer.useContainer();
  ...
  return (
    <>
      ...
      {importType !== undefined && <SuggestionsSearchInput importType={importType} />}
    </>
  );
};
