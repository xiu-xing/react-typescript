...
interface InstitutionGridPaginationBarProps {
  suffix: ReactNode;
  prefix: ReactNode;
}

const InstitutionGridPaginationBar: React.FunctionComponent<InstitutionGridPaginationBarProps> = (props) => {
...
export default InstitutionGridPaginationBar;
