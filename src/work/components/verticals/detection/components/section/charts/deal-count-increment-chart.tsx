...
import { getLineOption } from "../../chart/options";
import SectionContainer from "../sectionContainer";

const DealCountIncrementChart: React.FunctionComponent<{}> = () => {
  ...
  function chartDataHandler(data: Array<Array<string | number>>): EChartsOption {
    ...
    if (data.length) {
      try {
        ...
        option.legend.data[0].name = "交易事件数量同比增长率";
        option.legend.data[1].name = "交易事件数量";
...
export default DealCountIncrementChart;
