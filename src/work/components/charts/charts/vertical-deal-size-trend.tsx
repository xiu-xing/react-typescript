...
const VerticalDealSizeTrend: React.FunctionComponent = () => {
  ...
  return <Chart chartId="vertical.deal_size_trend" dataHandler={chartDataCallBack} filters={["dealType", "region"]} />;
};

export default VerticalDealSizeTrend;
