...
const Teams = _i1.OperationDefinitionNode(
...
const IsEmailBindingRequired = _i1.OperationDefinitionNode(
    type: _i1.OperationType.query,
...
const document = _i1.DocumentNode(definitions: [Teams, IsEmailBindingRequired]);
